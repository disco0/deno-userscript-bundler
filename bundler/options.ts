...
export const baseCompilerOptions: emit.CompilerOptions = {
...
export const browserCompilerOptions: emit.CompilerOptions = {
  ...baseCompilerOptions
//   lib: [
//     'DOM',
//     'DOM.Iterable',
...
export const emitOptions: emit.BundleOptions = {
  type: 'module',
